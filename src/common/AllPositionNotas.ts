...
export const allPositionNotas = [
  -72, -60, -47, -35, -23, -12, 0, 12, 25, 37, 49, 61, 74, 86, 98, 109, 122,
  134, 146,
];

export enum ClaveLabel {
  'sol' = 'position_sol',
  'fa' = 'position_fa',
  'do' = 'position_do',
...
export enum AllLabelPositionNotasFa {
  B1 = 146,
  C2 = 134,
  D2 = 122,
  E2 = 109,
...
export enum AllLabelPositionNotasDo {
  F2 = 146,
  G2 = 134,
  A2 = 122,
  B2 = 109,
...
export enum AllLabelPositionNotasDo3 {
  A2 = 146,
  B2 = 134,
  C3 = 122,
  D3 = 109,
